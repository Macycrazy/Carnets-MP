    ...
    public function up(): void
    {
        ...
        Schema::create('Access_levels', function (Blueprint $table) {
         ...
         Schema::create('Carnets', function (Blueprint $table) {
            ...
            $table->foreign('id_department')->references('id')->on('Department')->onupdate('cascade')->ondelete('cascade');
            $table->foreign('id_charge')->references('id')->on('Charge')->onupdate('cascade')->ondelete('cascade');
            $table->foreign('id_status')->references('id')->on('Status')->onupdate('cascade')->ondelete('cascade');
            $table->foreign('id_access_levels')->references('id')->on('Access_levels')->onupdate('cascade')->ondelete('cascade');
            $table->foreign('id_state')->references('id')->on('State')->onupdate('cascade')->ondelete('cascade');
        });
